...
const game = {
    ...
    checks() {
        if (!(mech.cycle % 60)) { //once a second
            ...
            //energy overfill 
            if (mech.energy > mech.maxEnergy) mech.energy = mech.maxEnergy + (mech.energy - mech.maxEnergy) * (mod.isSlowDecay ? 0.9 : 0.8) //every second energy above max energy loses 20%, 10% w/ mod
